  ...
  return (
    <footer className="text-center pt-2 animate-fade-in" style={{ animationDelay: '0.65s', animationFillMode: 'forwards' }}>
      ...
      <div className="text-cyber-dim text-[0.5rem] sm:text-[0.55rem] font-mono tracking-widest">
        <span>© {new Date().getFullYear()} HOMELAB</span><span className="mx-1 sm:mx-1.5">·</span><span>v3.2.0</span><span className="mx-1 sm:mx-1.5">·</span><span>SESSION ID: {sid}</span>
      </div>
    </footer>
  );
}
