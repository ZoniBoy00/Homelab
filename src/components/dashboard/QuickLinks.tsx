...
export default function QuickLinks() {
  ...
  return (
    <section className="animate-fade-in my-4" style={{ animationDelay: '0.45s', animationFillMode: 'forwards' }}>
      ...
      <div className="flex flex-wrap gap-1.5">
        {services.map((s) => (
          <a
            ...
            className="inline-flex px-3 py-1 font-mono text-xs font-medium no-underline bg-black/25 border transition-all duration-250 hover:-translate-y-0.5"
            style={{
